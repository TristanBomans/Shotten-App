...
// Migration 001: add forfait to core_matches
...
// Migration 002: link core teams/matches to LZV scraper ids
// (the hardcoded team UPDATE is handled by the setup wizard instead)
...
// Migration 004: LZV match details (lineups, goals, assists per match)
...
export const FULL_SETUP_SQL = [SCHEMA_SQL, MIGRATION_001_SQL, MIGRATION_002_SQL, MIGRATION_004_SQL].join('\n');
